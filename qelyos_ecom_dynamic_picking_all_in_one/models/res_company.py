...
class ResCompany(models.Model):
    ...
    ecom_dynamic_source_location_ids = fields.Many2many(
        ...
        help="Inclure CENTRAL/Stock puis les boutiques (ex: Gafsa/Stock, Sousse/Stock, Tunis/Stock)."
    )
    ...
    ecom_dynamic_strategy = fields.Selection(
        ...
        help="Règle de sélection de l'emplacement source lors de la création des pickings eCommerce."
    )
